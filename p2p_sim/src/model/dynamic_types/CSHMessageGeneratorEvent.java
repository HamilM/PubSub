...
public class CSHMessageGeneratorEvent extends AbstractMessasgeGeneratorEvent 
{

	private final static boolean fShowInTrace = true;

	public CSHMessageGeneratorEvent(Model owner, String name, boolean showInTrace)
	{
	...
	public void eventRoutine() 
	{
		...
		CSHMessageArrivalEvent messageArrivalEvent = new CSHMessageArrivalEvent(model, "Publisher sends new message", fShowInTrace);
